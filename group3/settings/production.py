...
STATIC_ROOT = os.path.join(BASE_DIR, "../../../../Documents/objor/group3/static_cdn", "static_root")

MEDIA_URL = 'media/'

MEDIA_ROOT = os.path.join(BASE_DIR, "../../../../Documents/objor/group3/static_cdn", "media_root")

from group3.aws.conf import *
